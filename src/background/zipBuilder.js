 ...
 * The export payload is small (a few hundred KB), so compression is not
 * worth third-party code in an extension. UTF-8 filenames (flag bit 11).
 */
(function (root, factory) {
  ...
  /**
   * files: [{name, content: string|Uint8Array|ArrayBuffer}]
